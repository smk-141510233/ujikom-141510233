        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <center><a href="<?php echo e(url('/jabat/create')); ?>" class="btn btn-success">Tambah Jabatan</a></center><br>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $jabatann; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('jabat.edit',$data->id)); ?>" class="btn btn-warning">Ubah</a></td>
                                    <td>
                                    <?php echo Form::open(['method' => 'DELETE', 'route'=>['jabat.destroy', $data->id]]); ?>
